...
def mock_rag_retrieval(monkeypatch):
    ...
    mock_documents: List[Dict] = [
        {
            "source": "mock_file1.md",
            "content": "This is a mock document about winter coats.",
            "score": 0.95,
        },
        {
            "source": "mock_file2.json",
            "content": "Another mock document about professional attire.",
            "score": 0.92,
        },
    ]
...
def test_invoke_retrieve_documents_with_missing_query_returns_400(client):
    ...
    """
    # Arrange
    payload = {"tool_name": "retrieve_documents", "input_data": {}}  # Missing 'query'
