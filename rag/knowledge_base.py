...
class MilvusKnowledgeBase:
    ...
    def __init__(
        ...
        logger.info(
            f"Initializing MilvusKnowledgeBase: {host}:{port}/{collection_name}"
        )
    ...
    def create_collection(self, recreate: bool = False) -> None:
        ...
        schema = CollectionSchema(
            fields=fields, description="Meridian Retail Knowledge Base"
        )
...
class DocumentStore:
    ...
    def load_document(
        self, doc_id: str, doc_type: str = None
    ...
    def import_data_files(self, data_dir: str = "./data") -> Dict[str, int]:
        ...
        if products_file.exists():
            with open(products_file, "r") as f:
                ...
                for product in products:
                    self.save_document(product["product_id"], product, "products")
        ...
        if trends_file.exists():
            with open(trends_file, "r") as f:
                trends = json.load(f)
                for trend in trends:
                    self.save_document(trend["trend_id"], trend, "trends")
        ...
        if insights_file.exists():
            with open(insights_file, "r") as f:
                ...
                for insight in insights:
                    self.save_document(insight["insight_id"], insight, "insights")
