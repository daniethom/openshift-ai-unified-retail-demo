...
class TrendAgent(BaseAgent):
    ...
    def __init__(
        ...
        capabilities = [
            ...
            AgentCapability(
                ...
                input_schema={"competitors": "array", "categories": "array"},
                output_schema={
                    "analysis": "object",
                    "opportunities": "array",
                    "threats": "array",
        ...
        self.sa_context = {
            ...
            "demographics": {
                ...
                "young_professional": {
                    "age": "25-35",
                    "preferences": "smart_casual, quality",
                },
    ...
    def get_tools(self) -> List[Any]:
        ...
        return [self.fashion_analyzer, self.trend_searcher, self.rag_retriever]
    ...
    async def _gather_trend_data(
        self, query: str, brand: str, season: str, location: str
    ) -> Dict[str, Any]:
        ...
        historical_data = await self.rag_retriever.retrieve(query=rag_context, top_k=5)
    ...
    async def _analyze_trends(
        self, trend_data: Dict[str, Any], demographic: str, location: str
    ) -> Dict[str, Any]:
        ...
        regional_adjustments = self._apply_regional_preferences(key_trends, location)
    ...
    async def _generate_recommendations(
        self, analysis: Dict[str, Any], brand: str, season: str, demographic: str
    ) -> List[Dict[str, Any]]:
        ...
        recommendations.append(
            {
                ...
                "action": "adjust",
                "categories": [
                    self._map_trend_to_category(t["name"])
    ...
    def _calculate_demographic_fit(self, trend: Dict, demographic: str) -> float:
        ...
        demographic_preferences = (
            self.sa_context["demographics"].get(demographic, {}).get("preferences", "")
        )
    ...
    def _apply_regional_preferences(
        self, trends: List[Dict], location: str
    ) -> Dict[str, Any]:
    ...
    def _calculate_quantity(
        self, trend: Dict, brand: str, demographic: str
    ) -> Dict[str, Any]:
    ...
    def _create_marketing_message(
        self, brand: str, season: str, analysis: Dict[str, Any]
    ) -> str:
